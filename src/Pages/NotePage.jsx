  ...
  return (
    <div className="w-[50%] max-md:w-[90%] mx-auto my-8 px-4 py-8 max-sm:px-0 max-sm:py-2">
      ...
      >
          ...
          addCategory ? (
            <div className='w-[90%] flex justify-between items-baseline'>
              ...
              <button type="button" onClick={() => setAddCategory(false)}
                className="px-4 p-2 flex justify-center items-center gap-2 hover:text-yellow-200 transition duration-100 ease-in-out"
              >
                Select
        ...
        <button type="submit"
          className="w-[50%] max-w-[200px] rounded-full px-4 py-2 bg-yellow-200 font-semibold hover:bg-yellow-300 transition  ease-in-out text-xl max-md:text-sm duration-500 flex justify-center items-center gap-2"
        >
          <Save fontSize="small" />
          Save
        </button>
