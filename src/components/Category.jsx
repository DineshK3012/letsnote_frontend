...
const Category = ({ category_id, title, total_notes }) => {
    ...
    return (
        <div className='w-fit min-w-[260px] border-[0.5px] rounded-lg p-3
            ...
            <Folder className='text-yellow-400' fontSize='large' />
                        ...
                        ? (
                            <div className='flex items-center'>
                                ...
                                <div className='mx-2 flex gap-4'>
                                    <Done className='cursor-pointer text-green-400 hover:bg-slate-50 rounded-full' fontSize='medium' onClick={onDone} />
