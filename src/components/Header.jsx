...
const Header = () => {
    ...
    return (
        <header className='py-2 bg-yellow-200 border-b-[0.5px] shadow-sm hover:shadow-md hover:transition-all'>
            <nav className="flex justify-center items-center">
                ...
                <ul className="flex flex-1 mr-4 max-md:mr-2 max-sm:mr-0 justify-start md:justify-end align-baseline max-md:gap-0 gap-4 drop-shadow-md  text-lg font-medium">
                    <li className={`mx-2 hover:font-bold hover:drop-shadow-md ${selectedTab === '/' ? 'font-bold drop-shadow-md' : ''} `}>
                        <Link to="/" onClick={() => setTab("/")}>
                            Home
                        </Link>
                    </li>
